    ...
    <div class="registerCont">
      <ul>
        ...
        <li> <span class="dis">验证码:</span>
          ...
          <img src="{{ URL::asset('/images/code.jpg') }}" alt="验证码" style="cursor:pointer;" id="yzm" class="valign"> <a class="look blue _changeCapcherButton" id="look" href="javascript:void(0);">看不清？换一张</a> <span class="info" id="jpgVerifys" data-info="请输入手机验证码"></span> </li>
