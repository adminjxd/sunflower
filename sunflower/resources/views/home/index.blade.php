  ...
  <div class="wrap">
    <div class="page-left fn-left">
      <div class="mod-borrow">
        ...
        <div class="bd">
          <div class="des"><span class="fn-left">期限1-29天，期限短，收益见效快</span><a href="{{ URL::route('invest/index') }}" class="fn-right">查看更多&gt;&gt;</a></div>
      ...
      <div class="mod-borrow mrt20">
        ...
        <div class="bd">
          <div class="des"><span class="fn-left">期限1-12月，收益更高</span><a href="{{ URL::route('invest/index') }}" class="fn-right">查看更多&gt;&gt;</a></div>
          <div class="borrow-list">
            <ul>
              <li>
      ...
      <div class="mod-borrow mrt20">
        ...
        <div class="bd">
          <div class="des"> <span class="fn-left">期限12-60月，打理更加容易</span><a href="{{ URL::route('invest/index') }}" class="fn-right">查看更多&gt;&gt;</a></div>
          <div class="borrow-list">
            <ul>
              <li>
      ...
      <div class="mod-borrow mrt20">
        ...
        <div class="bd">
          <div class="des"><span class="fl">其他投资人折价转让，转让项目会随时更新，惊喜不断</span><a href="{{ URL::route('invest/index') }}" class="fn-right">查看更多&gt;&gt;</a></div>
          <div class="borrow-list">
            <ul>
              <li>
